...
.layout {
	width: 400px; margin:30px auto 5px;
}
...
<div class="layout">
<form action="${pageContext.request.contextPath}/insa/request" method="post">
<table>
	<tr height="35" style="border-top:2px solid #ccc; border-bottom:1px solid #ccc;">
	...
	<tr height="35" style="border-bottom:2px solid #ccc;">
